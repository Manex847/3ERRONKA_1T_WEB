...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['eskatu_ordua'])) {
    ...
    try {
        ...
        $mezua = "<p style='color: green; text-align: center; font-size: 1.2rem; font-weight: bold;'>Zita ondo gorde da datu-basean!</p>";
    } catch(PDOException $e) {
        $mezua = "<p style='color: red; text-align: center; font-weight: bold;'>Errorea zita gordetzean: " . $e->getMessage() . "</p>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Eskatu Ordua - A1A Car Wash</title>
        ...
        <div class="eskatu-container">
            ...
            <form action="eskatuordua.php" method="POST">
                ...
                <div class="form-taldea">
                    ...
                    <input type="number" name="prezioa" id="prezioa" readonly required placeholder="Automatiko kalkulatua">
                </div>

                <button type="submit" class="botoia-bidali">Gorde Zita</button>
            </form>
        </div>
    </main>
